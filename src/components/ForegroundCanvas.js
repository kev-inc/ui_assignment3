...
class ForegroundCanvas extends React.Component {
  ...
  renderForeground() {
    ...
    const current_temp = this.props.currentTemp
    const target_temp = this.props.targetTemp
    const { current_color, hot_color, cool_color, stroke_weight, ticks } = this.state
    const canvas = this.refs.canvas
